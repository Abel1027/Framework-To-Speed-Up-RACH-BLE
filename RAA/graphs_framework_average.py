...
for index, iter_file in enumerate(iterations):
	...
	file = open('!best_logs/' + iter_file + '/02-BLE.log')
	lines = file.readlines()
	file.close()
	elements_in_line = 0
	for lineIndex in range(0, len(lines), 2):
	...
	file = open('!best_logs/' + iter_file + '/03-BLERandom.log')
	lines = file.readlines()
	file.close()
	elements_in_line = 0
	for lineIndex in range(0, len(lines), 2):
	...
	file = open('!best_logs/' + iter_file + '/04-WiFi.log')
	lines = file.readlines()
	file.close()
	elements_in_line = 0
	for lineIndex in range(0, len(lines), 2):
...
plt.title('Histogram for device registration (1000 devices) - RACH')
...
hist_f = [float(_)/1000 for _ in hist_f_]
plt.hist(hist_f, bins=len(hist_f))
plt.title('Histogram for device registration (1000 devices) - RAA')
plt.xlabel('Timestamps where devices were registered (ms)')
plt.ylabel('Number of devices registered')
plt.grid(True)
...
plt.plot(totalDevices2, totalCollisions24Band2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalCollisions24Band3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalCollisions24Band4, '-s', label='RAA (Wi-Fi)')
plt.plot(totalDevices2, totalCollisions24Band5, '-x', label='RAA (Wi-Fi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisionsNetwork2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalCollisionsNetwork3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalCollisionsNetwork4, '-s', label='RAA (Wi-Fi)')
plt.plot(totalDevices2, totalCollisionsNetwork5, '-x', label='RAA (Wi-Fi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisions2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalCollisions3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalCollisions4, '-s', label='RAA (Wi-Fi)')
plt.plot(totalDevices2, totalCollisions5, '-x', label='RAA (Wi-Fi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, [i*2.3726 for i in totalEnergy24Band2], '-o', label='RAA (BLE)') # 6.31mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*2.3726 for i in totalEnergy24Band3], '-v', label='RAA (BLE random)') # 6.31mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*37.6 for i in totalEnergy24Band4], '-s', label='RAA (Wi-Fi)') # 100mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*37.6 for i in totalEnergy24Band5], '-x', label='RAA (Wi-Fi random)') # 100mW * 376bits / 1Mbps
plt.yscale('log')
...
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork2], '-o', label='RAA (BLE)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork3], '-v', label='RAA (BLE random)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork4], '-s', label='RAA (Wi-Fi)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork5], '-x', label='RAA (Wi-Fi random)') # 251.19mW * 72bits / 100Mbps
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergy2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalEnergy3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalEnergy4, '-s', label='RAA (Wi-Fi)')
plt.plot(totalDevices2, totalEnergy5, '-x', label='RAA (Wi-Fi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB2], '-o', label='RAA (BLE)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB3], '-v', label='RAA (BLE random)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB4], '-s', label='RAA (Wi-Fi)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB5], '-x', label='RAA (Wi-Fi random)') # 251.19mW * 72bits / 100Mbps
plt.yscale('log')
...
plt.plot(totalDevices2, totalTimeForRegistration2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalTimeForRegistration3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalTimeForRegistration4, '-s', label='RAA (Wi-Fi)')
plt.plot(totalDevices2, totalTimeForRegistration5, '-x', label='RAA (Wi-Fi random)')
plt.yscale('log')
