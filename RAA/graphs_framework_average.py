...
plt.plot(totalDevices2, totalCollisions24Band4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalCollisions24Band5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisionsNetwork4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalCollisionsNetwork5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisions4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalCollisions5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergy24Band2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalEnergy24Band3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalEnergy24Band4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalEnergy24Band5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergyNetwork2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalEnergyNetwork3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalEnergyNetwork4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalEnergyNetwork5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergy4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalEnergy5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergyGNB2, '-o', label='RAA (BLE)')
plt.plot(totalDevices2, totalEnergyGNB3, '-v', label='RAA (BLE random)')
plt.plot(totalDevices2, totalEnergyGNB4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalEnergyGNB5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalTimeForRegistration4, '-s', label='RAA (WiFi)')
plt.plot(totalDevices2, totalTimeForRegistration5, '-x', label='RAA (WiFi random)')
plt.yscale('log')
