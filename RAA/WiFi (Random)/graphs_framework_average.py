...
plt.plot(totalDevices2, totalEnergy24Band2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalEnergy24Band3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalEnergy24Band4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergy24Band5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalEnergyNetwork2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalEnergyNetwork3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalEnergyNetwork4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergyNetwork5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.figure(figsize=(8, 8))
#plt.plot(totalDevices, totalEnergy, '-d', label='RACH')
plt.plot(totalDevices2, totalEnergy2, '-o', label='RAA (after SIB1)')
plt.plot(totalDevices2, totalEnergy3, '-v', label='RAA (before SIB1)')
plt.plot(totalDevices2, totalEnergy4, '-s', label='RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergy5, '-x', label='RAA (before SIB1 + frequency assigned by gNB)')
#plt.yscale('log')
plt.title('Total energy consumption (2.4 GHz band + Mobile Network band)')
plt.xlabel('Total devices attempting to obtain resources from the network')
plt.ylabel('Energy consumption (units)')
...
plt.plot(totalDevices2, totalEnergyGNB2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalEnergyGNB3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalEnergyGNB4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergyGNB5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
