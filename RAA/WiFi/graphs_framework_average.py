...
plt.plot(totalDevices2, totalCollisions24Band2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalCollisions24Band3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalCollisions24Band4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisions24Band5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisionsNetwork2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalCollisionsNetwork3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalCollisionsNetwork4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisionsNetwork5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.plot(totalDevices2, totalCollisions2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalCollisions3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalCollisions4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalCollisions5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.plot(totalDevices2, [i*2.3726 for i in totalEnergy24Band2], '-o', label='RACH + RAA (after SIB1)') # 6.31mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*2.3726 for i in totalEnergy24Band3], '-v', label='RACH + RAA (before SIB1)') # 6.31mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*37.6 for i in totalEnergy24Band4], '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)') # 100mW * 376bits / 1Mbps
plt.plot(totalDevices2, [i*37.6 for i in totalEnergy24Band5], '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)') # 100mW * 376bits / 1Mbps
plt.yscale('log')
...
plt.figure(figsize=(8, 8))
plt.plot(totalDevices, [i*0.1809 for i in totalEnergyNetwork], '-d', label='RACH') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork2], '-o', label='RACH + RAA (after SIB1)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork3], '-v', label='RACH + RAA (before SIB1)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork4], '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyNetwork5], '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)') # 251.19mW * 72bits / 100Mbps
plt.yscale('log')
...
totalEnergy = [i+j for i,j in zip(totalEnergy24Band, [i*0.1809 for i in totalEnergyNetwork])]
totalEnergy2 = [i+j for i,j in zip([i*2.3726 for i in totalEnergy24Band2], [i*0.1809 for i in totalEnergyNetwork2])]
totalEnergy3 = [i+j for i,j in zip([i*2.3726 for i in totalEnergy24Band3], [i*0.1809 for i in totalEnergyNetwork3])]
totalEnergy4 = [i+j for i,j in zip([i*37.6 for i in totalEnergy24Band4], [i*0.1809 for i in totalEnergyNetwork4])]
totalEnergy5 = [i+j for i,j in zip([i*37.6 for i in totalEnergy24Band5], [i*0.1809 for i in totalEnergyNetwork5])]
plt.figure(figsize=(8, 8))
plt.plot(totalDevices, totalEnergy, '-d', label='RACH')
plt.plot(totalDevices2, totalEnergy2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalEnergy3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalEnergy4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalEnergy5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.savefig('!graphs_average/energy_total.eps')
plt.show()

plt.figure(figsize=(8, 8))
plt.plot(totalDevices, [i*0.1809 for i in totalEnergyGNB], '-d', label='RACH') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB2], '-o', label='RACH + RAA (after SIB1)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB3], '-v', label='RACH + RAA (before SIB1)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB4], '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)') # 251.19mW * 72bits / 100Mbps
plt.plot(totalDevices2, [i*0.1809 for i in totalEnergyGNB5], '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)') # 251.19mW * 72bits / 100Mbps
plt.yscale('log')
...
plt.savefig('!graphs_average/energy_gNB.eps')
plt.show()

plt.figure(figsize=(8, 8))
plt.plot(totalDevices, totalTimeForRegistration, '-d', label='RACH')
plt.plot(totalDevices2, totalTimeForRegistration2, '-o', label='RACH + RAA (after SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration3, '-v', label='RACH + RAA (before SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration4, '-s', label='RACH + RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalTimeForRegistration5, '-x', label='RACH + RAA (before SIB1 + frequency assigned by gNB)')
plt.yscale('log')
...
plt.figure(figsize=(8, 8))
#plt.plot(totalDevices, totalTimeForRegistration, '-d', label='RACH')
plt.plot(totalDevices2, totalTimeForRegistration2, '-o', label='RAA (after SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration3, '-v', label='RAA (before SIB1)')
plt.plot(totalDevices2, totalTimeForRegistration4, '-s', label='RAA (after SIB1 + frequency assigned by gNB)')
plt.plot(totalDevices2, totalTimeForRegistration5, '-x', label='RAA (before SIB1 + frequency assigned by gNB)')
#plt.yscale('log')
plt.title('Total time for all devices registration (ms)')
plt.ylabel('Time (ms)')
plt.xlabel('Total devices attempting to obtain resources from the network')
...
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], totalDownlinkSC6, label='RAA')
...
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], totalUplinkSC6, label='RAA')
...
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], totalDownlinkSC7, label='RAA')
...
plt.plot(['12/5', '24/5', '36/5', '12/10', '24/10', '36/10', '12/14', '24/14', '36/14'], totalUplinkSC7, label='RAA')
